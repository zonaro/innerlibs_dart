...
class InnerLibsLocalizationsPtBr extends InnerLibsLocalizationsPt {
  ...
  String confirmDeleteMultiple(int count, String singular, String plural) {
    ...
    return 'Confirmar Exclusão Múltipla';
  }
  ...
  @override
  String couldNotFindItem(String item) {
    return 'Não foi possível encontrar o item';
  }
  ...
  @override
  String get undock => 'Desancorar';

  @override
  String undockItem(String item) {
    return 'Desancorar Item';
  }
