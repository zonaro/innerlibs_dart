...
enum ColorNames {
  ...
  const ColorNames(this.hexadecimal, this.name);

  factory ColorNames.fromValue(String value) {
  ...
  HSVColor get hsvColor => HSVColor.fromString(hexadecimal, name);
