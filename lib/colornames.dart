...
enum NamedColors {
  ...
  const NamedColors(this.hexadecimal, this.name);

  factory NamedColors.fromValue(String value) {
    for (var color in values) {
      if (color.hexadecimal.flatEqual(value) || color.name.flatEqual(value) || generateKeyword(value).flatEqual(color.keyword)) {
        return color;
      }
    }
