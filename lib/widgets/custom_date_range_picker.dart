...
import 'package:innerlibs/date_extension.dart';
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    selectedRange?.startDate != null ? DateFormat('EEE, dd MMM').format(selectedRange!.startDate) : '--/-- ',
                                    style: TextStyle(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    selectedRange?.endDate != null ? DateFormat('EEE, dd MMM').format(selectedRange!.endDate) : '--/-- ',
                                    style: TextStyle(
                                      fontWeight: FontWeight.bold,
                                      fontSize: 16,
                                      color: Colors.grey.shade700,
                        ...
                        SizedBox(
                          ...
                          child: CustomCalendar(
                            ...
                            startEndDateChange: (DateTime startDateData, DateTime endDateData) {
                              ...
                              setState(() {
                                selectedRange!.startDate = startDateData;
                                selectedRange!.endDate = endDateData;
                              });
                            },
                          ),
                        ),
                              ...
                              Expanded(
                                child: Container(
                                  ...
                                  child: OutlinedButton(
                                    ...
                                    onPressed: () {
                                      try {
                                        widget.onApplyClick(selectedRange);
                                        Navigator.pop(context);
                                      } catch (_) {}
                                    },
                                    child: const Center(
